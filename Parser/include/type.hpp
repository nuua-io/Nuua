...
class Type
{
    ...
    public:
        ...
        Type(ValueType type, std::shared_ptr<Type> &inner_type)
        ...
        bool cast(std::shared_ptr<Type> &to, CastType *dest_casttype = nullptr);
        ...
        bool unary(Token &op, const std::shared_ptr<Type> &dest_type = std::shared_ptr<Type>(), UnaryType *dest_unarytype = nullptr);
        ...
        bool binary(Token &op, std::shared_ptr<Type> &t1, const std::shared_ptr<Type> &dest_type = std::shared_ptr<Type>(), BinaryType *dest_bintype = nullptr);
        ...
        bool same_as(std::shared_ptr<Type> &type);
        bool same_as(Type &type);
